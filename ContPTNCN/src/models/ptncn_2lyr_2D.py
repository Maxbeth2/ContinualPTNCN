...
class PTNCN:
    def __init__(self, name, x_dim, hid_dim, wght_sd=0.025, err_wght_sd=0.025,act_fun="tanh", init_type="normal",
        ...
        self.W1A = tf.Variable( init_weights(self.init_type, [self.hid_dim, self.x_dim], stddev=wght_sd, seed=seed) )
        self.W1B = tf.Variable( init_weights(self.init_type, [self.hid_dim, self.x_dim], stddev=wght_sd, seed=seed) )
